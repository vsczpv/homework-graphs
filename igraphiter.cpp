...
DijkstraIGraphBFSIter DijkstraIGraphBFSIterGen::begin()
{
	return DijkstraIGraphBFSIter(m_graph, false, m_visits, m_root);
}

DijkstraIGraphBFSIter DijkstraIGraphBFSIterGen::end()
{
	return DijkstraIGraphBFSIter(m_graph, true, m_visits, 0);
}

DijkstraIGraphBFSIter& DijkstraIGraphBFSIter::operator=(const DijkstraIGraphBFSIter& rhs)
{
	if (this == &rhs)
		return *this;

	/* ugly workaround */
	memcpy((void*)this, (void*)&rhs, sizeof(DijkstraIGraphBFSIter));
	return *this;
}

DijkstraIGraphBFSIter& DijkstraIGraphBFSIter::operator++()
{
...
id_t DijkstraIGraphBFSIter::operator*() const
{
	return m_current_node;
}
...
bool operator==(const DijkstraIGraphBFSIter& lhs, const DijkstraIGraphBFSIter& rhs)
{
